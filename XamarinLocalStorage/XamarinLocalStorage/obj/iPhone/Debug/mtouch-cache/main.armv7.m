...
extern void *mono_aot_module_XamarinLocalStorage_info;
...
extern void *mono_aot_module_SimpleStorage_iOS_info;
extern void *mono_aot_module_SQLite_info;

void monotouch_register_modules ()
{
	mono_aot_register_module (mono_aot_module_XamarinLocalStorage_info);
	...
	mono_aot_register_module (mono_aot_module_SimpleStorage_iOS_info);
...
void monotouch_setup ()
{
	...
	monotouch_assembly_name = "XamarinLocalStorage.exe";
	mono_use_llvm = FALSE;
